...
<body class="index-page">
    ...
    <section id="products" class="products section">
        <div class="container section-title">
            ...
            <p><span>Organic</span> <span class="description-title"> No Preservatives</span></p>
        </div>
        ...
        <div class="container">
            <div class="row d-flex">
                ...
                $sql = "SELECT id, name, image FROM Organic";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<div class='main-card col-sm-12 col-md-6 col-lg-4 col-xl-3 mb-5 d-flex'>";
                        echo "<a href='our_product_description3.php?id=" . $row['id'] . "&category=OrganicDetails'>";
                        ...
                        echo "<a href='our_product_description3.php?id=" . $row['id'] . "&category=OrganicDetails' class='fw-bold' style='color: #ffa500;'>Read More</a>";
                        echo "</div>";
