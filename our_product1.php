...
<body class="index-page">
    ...
    <div class="container section-title">
        ...
        <p><span>Frozen</span> <span class="description-title">No Preservatives</span></p>
    </div>
    ...
    <div class="container">
        <div class="row d-flex">
            ...
            $sql = "SELECT id, name, image FROM frozen";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<div class='main-card col-sm-12 col-md-6 col-lg-4 col-xl-3 mb-5 d-flex'>";
                    echo "<a href='our_product_description1.php?id=" . $row['id'] . "&category=FrozenDetails'>";
                    echo "<div class='card d-flex flex-column align-items-center p-3 w-100 mx-1' style='border-radius: 15px;  height: 100%;'>";
                    ...
                    echo "<a href='our_product_description1.php?id=" . $row['id'] . "&category=FrozenDetails' class='fw-bold' style='color: #ffa500;'>Read More</a>";
                    echo "</div>";
